...
router.get('/shop', userauth, async (req, res) => {
    try {
...
router.post('/status-update/:order_id', userauth, async (req, res) => {
    try {
...
router.get('/payment-update/:order_id', userauth, async (req, res) => {
    try {
        const orderId = req.params.order_id;
        const status = req.body.status;
